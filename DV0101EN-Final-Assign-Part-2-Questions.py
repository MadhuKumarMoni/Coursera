...
app.layout = html.Div([
    ...
    html.H1("Automobile Statistics Dashboard", style={'color': '#503D36', 'font-size': 24}),#Include style for title
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
            ...
            x='Vehicle_Type',
            y='Automobile_Sales',
            title="Vehicle Type wise Average Automobile Sales"))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        #unemp_data = pd.DataFram(recession_data.groupby(['Vehicle_Type','unemployment_rate'])['Automobile_Sales'].count())
        unemp_data = recession_data.groupby(['Vehicle_Type','unemployment_rate']).size().reset_index(name='Automobile_Sales')
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots
    ...
    elif (input_year and statistics=='Yearly Statistics') :
